package com.pradeep.flightreservation.util;
...
public class EmailUtil {
	@Value("${com.pradeep.flightreservation.itinerary.email.body}")
	private String EMAIL_BODY = "Please find your Itinerary attached.";

	@Value("${com.pradeep.flightreservation.itinerary.email.subject}")
